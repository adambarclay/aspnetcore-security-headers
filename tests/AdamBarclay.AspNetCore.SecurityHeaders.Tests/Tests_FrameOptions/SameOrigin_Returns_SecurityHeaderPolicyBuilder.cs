...
{
	public static class SameOrigin_Returns_SecurityHeaderPolicyBuilder
	{
		[Fact]
		public static void Always()
		{
			...
			Assert.Same(securityHeaderPolicyBuilder, securityHeaderPolicyBuilder.FrameOptions.SameOrigin());
		}
	}
}
